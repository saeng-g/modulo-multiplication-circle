...
public void draw_lines(float mult, int mod) {
  for (int i = 0; i < num_points; i++) {
    //connect(i, mod);
...
public void connect_modulo(int start_index, float multiplier, int modulo) {
...
public void keyPressed() {
  if (key == CODED) {
    ...
    else if (key == '2') multiplier_modifier = 0.1f;
    else if (key == '3') multiplier_modifier = 0.01f;
  }
}
